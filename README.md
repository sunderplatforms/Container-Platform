...
The first service, `fixture-service`, is now scaffolded with a Node.js API, tests, Docker image, and Kubernetes manifests. See [the getting-started guide](docs/getting-started.md) to run it locally or deploy it to a cluster.

The first tenant and Argo CD deployment definitions are documented in [the GitOps guide](docs/gitops.md).
...
```
cd existing_repo
git remote add origin https://gitlab.com/acp-group3273029/alex-container-platform.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/acp-group3273029/alex-container-platform/-/settings/integrations)
